...
<head>
	<meta charset="utf-8">
	<title>Quiniela_Mundial_2018/posiciones_select</title>
...
<nav>
<div id="usuario"><?php echo "Bienvenido: " . $_SESSION["usuario"] . "&nbsp;&nbsp;&nbsp;"; ?></div>
<div>
...
<blockquote><a href="QMF2016_Adm_Calendario.php">Calendario</a></blockquote><blockquote><a href="QMF2016_Adm_Reglas.php">Reglas</a></blockquote>
...
<br><br><br>
	...
	<form action='QMF2016_Posiciones.php' method='post'>
	<table style="width:500px; margin-left:100px">

<?php
try{
	
	$quin_select=htmlentities(addslashes($_POST['quin_select']));
	

	echo "<tr><td>Usted seleccionó la quiniela del Usuario</td></tr>
	<tr><td><input style='width:300px' type='text' name='quiniela_devuelta_user' value='$quin_select'></td></tr>
	<tr><td>Por favor presione el sigueinte botón para continuar</td></tr>
	<tr><td><input type='submit' name='volver' value='Volver'></td></tr>
	</table></form>";
