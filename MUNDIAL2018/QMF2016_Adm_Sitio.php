...
<head>
    <meta charset="utf-8">
	<title>Quiniela_Mundial_2018/Adm_Sitio</TITLE>
	...
	<script>
        ...
        function CambiarImagenConEfecto(){
            ...
            $("#imagen01").fadeIn(1000).delay(900);
            // obtenemos un numero aleatorio entre 0 y la cantidad de imagenes que hay
            var index=Math.floor((Math.random()*imagenes.length));
            // cambiamos la imagen
            document.getElementById("imagen01").src=imagenes[index];
            // aparece la imagen
            $("#imagen01").fadeOut(500);
        }
        /*Función que se ejecuta una vez cargada la página*/
        onload=function(){
            // Indicamos que cada 5 segundos cambie la imagen
            setInterval(CambiarImagenConEfecto,2500);
        }
    </script>
...
<header>
  <h1><strong id="titulo_en movimiento">Quiniela RUSIA-2018</strong><br><h2 style="font-size:24px">Autenticaci&oacute;n de Administrador</h2></h1>
</header>
<br><br>
<section>
<br>
<form name="inicio_usuario" id="inicio_usuario" method="post" action="QMF2016_Comprueba_Admin.php">
<table>
	<tr>
		<td>Usuario</td>
		<td><input type="text" name="nombre_admin" id="nombre_admin" required></td>
	</tr>	

	<tr>	
        <td>Contraseña</td>
		<td><input type="password" name="contrasena_admin" id="contrasena_admin" required></td>
	</tr>

	<tr>	
		<td colspan="2"><input type="submit" name="ingresar" id="ingresar" value="Ingrear" required style="margin: 5px 120px"></td>
	</tr>
</form>
 
    <tr>	
	<td colspan="2" class="vinculo"><a href="index.php">Volver al Inicio</a></td>
	</tr>
    
</table>
  <br>
  <br>
  <div style="height:220px; width:400px; margin:auto; border:#060 ridge 7px; box-shadow:#333 10px 5px 10px;	border-radius:30px; background-color:#333333;"><img style="height:220px; width:400px; margin:auto; border-radius:30px; background-color:#333333;" width="400px" height="220px" src="IMAGENES2/MEJORESEQUIPOS13.png" id="imagen01"></div>
