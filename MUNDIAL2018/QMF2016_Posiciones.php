...
if(!isset($_POST['quiniela_devuelta_user'])){$quin_devuelta=$_SESSION["usuario"];}
if(isset($_POST['quiniela_devuelta_user'])){$quin_devuelta=$_POST['quiniela_devuelta_user'];}
...
<!DOCTYPE HTML>
	...
	<title>Quiniela_Mundial_2018/posiciones</TITLE>
...
?>
    ...
    <td>
    	<table>
          <tr>
            <form name="selct_quiniela" action="QMF2016_Posiciones_Select.php" method="post"><td colspan='6'>
            <label>Selecciona otra Quiniela:</label>
