...
<blockquote><a href="QMF2016_Adm_Calendario.php">**Calendario**</a></blockquote>
<blockquote><a href="QMF2016_Adm_Tabla_Usuarios.php">Usuarios</a></blockquote><blockquote><a href="QMF2016_Adm_Reglas.php">Reglas</a></blockquote>
<blockquote><a href="QMF2016_Adm_Grupos.php">Grupos</a></blockquote>
</div>
</nav>

<section>
<h2 style="margin-left:120px">Plantilla para Cambiar Calendario de Partidos</h2>
<h4 style="margin-left:100px">(USAR SÓLO 3 LETRAS EN MAYUSCULA PARA CADA EQUIPO)</h2>
<table>
  <tr>
    <td>Juego</td>
    <td>Fecha</td>
...
try{
	...
	$consulta="SELECT * FROM `calendario` ORDER BY FECHA, HORA LIMIT $empesar_desde,$registros_filtrados";
	...
	while(($fila=mysqli_fetch_array($resultados))==true){
		...
		$ciudad=$fila['CIUDAD'];
	echo "<form action='QMF2016_Adm_Calendario_Update.php' method='post'><tr><td>";
	echo "$id<input type='hidden' name='id' value='$id'></td><td>";
	echo "<input type='text' name='fecha' value='$fecha'></td><td>";
	echo "<input type='text' name='hora' value='$hora'></td><td>";
	echo "<input type='text' name='descripcion' value='$descripcion'></td><td>";
	echo "<input type='text' name='equipo01' value='$equipo01' style='width:60px;'></td><td>";
	echo "<input type='text' name='equipo02' value='$equipo02' style='width:60px;'></td><td>";
	echo "<input type='text' name='ciudad' value='$ciudad' style='width:150px;'></td><td>";
	echo "<input type='submit' name='actualizar' value='Actualizar'></td></form>";
	echo "</tr>";
	}
