...
<head>
<meta charset="utf-8">
<title>Quiniela_Mundial_2018/Adm_Grupos</title>
...
<section>
<br>
<h2 style="margin-left:150px">Plantilla para modificar Nombre de Equipos</h2>
<h4 style="margin-left:120px">(USAR SÓLO 3 LETRAS EN MAYUSCULA PARA CADA EQUIPO)</h2>
...
try{
	...
	while(($fila=mysqli_fetch_array($resultados))==true){
		...
		$equipo03=$fila['EQ3'];
		$equipo04=$fila['EQ4'];
	echo "<form action='QMF2016_Adm_Grupos_Update.php' method='post'><tr><td>";
	echo "$grupo<input type='hidden' name='grupo' value='$grupo'></td><td>";
	echo "<input type='text' name='equipo01' value='$equipo01'></td><td>";
	echo "<input type='text' name='equipo02' value='$equipo02'></td><td>";
	echo "<input type='text' name='equipo03' value='$equipo03'></td><td>";
	echo "<input type='text' name='equipo04' value='$equipo04'></td>";
